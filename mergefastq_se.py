...
parser.add_argument("-i", "--read", type=str, action="append", help="Read1 file. Can be applied many", required=True)
parser.add_argument("-o", "--out", type=str, help="Output file1", required=True)
